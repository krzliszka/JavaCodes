...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        result = result % 3; // reszta z (4%3) = 1
        ...
        if((topScore > 90) && (topScore < 100)) {
            System.out.println("Greater than secondTop and less than 100.");
        }
        ...
        double doubleResult = (doubleVal1 + doubleVal2)*100.00;
        System.out.println("Result = " + doubleResult);
        double modulo = doubleResult % 40.00;
        System.out.println("Remainder = " +modulo);
        boolean isBoolean = (modulo == 0) ? true : false;
